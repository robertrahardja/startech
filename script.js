    ...
    contactForm.addEventListener('submit', async function (e) {
      ...
      try {
        ...
        if (result.success) {
          ...
          showNotification('success', 'Message Sent Successfully!', 'Thank you for reaching out. We\'ll get back to you.');
          // Reset form
          contactForm.reset();
        } else {
          // Show error message
          showNotification('error', 'Failed to Send', result.error || 'Please try again');
        }
      } catch (error) {
        console.error('Form submission error:', error);
        showNotification('error', 'Connection Error', 'Please check your connection and try again.');
      } finally {
