      ...
      <div className="animate-fade-in-up space-y-4">
        <div className="rounded-xl border border-st-border bg-st-bg-card p-5">
          ...
          <div className="mb-5 flex items-start justify-between border-b border-st-border pb-4">
            <div>
              <h3 className="text-[17px] font-normal tracking-wide text-st-text">
                QUOTATION
              </h3>
            ...
            <p className="text-[12px] font-normal text-st-text-muted">{date}</p>
          </div>

          {/* Client */}
          <div className="mb-5">
            <p className="text-[11px] font-medium tracking-wide text-st-text-muted">
              Bill To
            </p>
            <p className="mt-1 text-[13px] font-normal text-st-text">{client}</p>
          </div>
            ...
            <table className="w-full text-[13px] font-normal">
              <thead>
                <tr className="border-b border-st-border text-left text-st-text-muted">
                  ...
                  <th className="pb-2 text-right font-normal">Amount (SGD)</th>
                </tr>
              </thead>
              <tbody>
                {items.map((item, i) => (
          ...
          {/* Footer */}
          <div className="mt-5 space-y-2 border-t border-st-border pt-4 text-[12px] font-normal text-st-text-muted">
            {terms && (
              <p>
                <span className="text-st-text/60">Terms:</span> {terms}
              </p>
            )}
            <p>
              <span className="text-st-text/60">Valid for:</span> {validityDays}{" "}
              days
            </p>
          </div>
        </div>
